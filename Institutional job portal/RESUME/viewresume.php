<?PHP
	...
	$query="SELECT * FROM `resume1` where `usn`='$usn'";
	
	$hno_query=mysqli_query($link,"SELECT `hno` FROM `resume1` where `usn`='$usn'");
	$hno_array=mysqli_fetch_assoc($hno_query);
	$hno=$hno_array['hno'];
	
	$street_query=mysqli_query($link,"SELECT `street` FROM `resume1` where `usn`='$usn'");
	$street_array=mysqli_fetch_assoc($street_query);
	$street=$street_array['street'];
	
	$city_query=mysqli_query($link,"SELECT `city` FROM `resume1` where `usn`='$usn'");
	$city_array=mysqli_fetch_assoc($city_query);
	$city=$city_array['city'];
	
	$state_query=mysqli_query($link,"SELECT `state` FROM `resume1` where `usn`='$usn'");
	$state_array=mysqli_fetch_assoc($state_query);
	$state=$state_array['state'];
	
	$country_query=mysqli_query($link,"SELECT `country` FROM `resume1` where `usn`='$usn'");
	$country_array=mysqli_fetch_assoc($country_query);
	$country=$country_array['country'];
	
	$pin_query=mysqli_query($link,"SELECT `pin` FROM `resume1` where `usn`='$usn'");
	$pin_array=mysqli_fetch_assoc($pin_query);
	$pin=$pin_array['pin'];
			
	$name_query=mysqli_query($link,"SELECT `fullname` FROM `resume1` where `usn`='$usn'");
	$name_array=mysqli_fetch_assoc($name_query);
	$name=$name_array['fullname'];
	
	$mobileno_query=mysqli_query($link,"SELECT `mobile` FROM `resume1` where `usn`='$usn'");
	$mobileno_array=mysqli_fetch_assoc($mobileno_query);
	$mobileno=$mobileno_array['mobile'];
	
	$email_query=mysqli_query($link,"SELECT email FROM `resume1` where `usn`='$usn'");
	$email_array=mysqli_fetch_assoc($email_query);
	$email=$email_array['email'];	
	
	$website_query=mysqli_query($link,"SELECT `website` FROM `resume1` where `usn`='$usn'");
	$website_array=mysqli_fetch_assoc($website_query);
	$website=$website_array['website'];
	
	$linkedin_query=mysqli_query($link,"SELECT `linkedin` FROM `resume1` where `usn`='$usn'");
	$linkedin_array=mysqli_fetch_assoc($linkedin_query);
	$linkedin=$linkedin_array['linkedin'];
	
	$github_query=mysqli_query($link,"SELECT `github` FROM `resume1` where `usn`='$usn'");
	$github_array=mysqli_fetch_assoc($github_query);
	$github=$github_array['github'];
	
	$careerobjective_query=mysqli_query($link,"SELECT `careerobjective` FROM `resume1` where `usn`='$usn'");
	$careerobjective_array=mysqli_fetch_assoc($careerobjective_query);
	$careerobjective=$careerobjective_array['careerobjective'];
	
	$betotal_query=mysqli_query($link,"SELECT `betotal` FROM `resume1` where `usn`='$usn'");
	$betotal_array=mysqli_fetch_assoc($betotal_query);
	$betotal=$betotal_array['betotal'];
	
	$becollege_query=mysqli_query($link,"SELECT `becollege` FROM `resume1` where `usn`='$usn'");
	$becollege_array=mysqli_fetch_assoc($becollege_query);
	$becollege=$becollege_array['becollege'];
	
	$beuniversity_query=mysqli_query($link,"SELECT `beuniversity` FROM `resume1` where `usn`='$usn'");
	$beuniversity_array=mysqli_fetch_assoc($beuniversity_query);
	$beuniversity=$beuniversity_array['beuniversity'];
	
	$beyear_query=mysqli_query($link,"SELECT `beyear` FROM `resume1` where `usn`='$usn'");
	$beyear_array=mysqli_fetch_assoc($beyear_query);
	$beyear=$beyear_array['beyear'];
	
	$preuniversitymarks_query=mysqli_query($link,"SELECT `preuniversitymarks` FROM `resume1` where `usn`='$usn'");
	...
	echo "<table class='technical'>";
		...
		if($tools!=NULL)
		{
			echo "<tr> <th>Operating Systems</th> <td>:</td> <td>$tools</td> </tr>";
		}
		if($os !=NULL)
		{
			echo "<tr> <th>Skills</th> <td>:</td> <td>$os</td> </tr>";
		}
	echo "</table>";
	}
	echo "</div>";
